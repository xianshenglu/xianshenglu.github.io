<template>
 <section class="page page-intro" >
   ...
   <div class="page-intro-detail intro-value">
     <h3 class="intro-value-text" >{{introduction.value}}</h3>
   </div>
...
.intro-data .intro-data-detail {
  flex: 1 1 auto;
}
.intro-data .intro-data-info,
.intro-data .intro-data-contact {
  display: flex;
